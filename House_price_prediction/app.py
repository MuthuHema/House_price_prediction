...
model = pk.load(open(r"C:\Users\hema\OneDrive\Pictures\House_price_prediction\House_prediction_model.pkl", "rb"))

st.header("House Price Predictor")

# Corrected file path for CSV
data = pd.read_csv(r"C:\Users\hema\OneDrive\Pictures\House_price_prediction\Cleaned_data.csv")
